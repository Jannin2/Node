...
function unirseAlJuego() {
    fetch("http://192.168.5.113:8000/unirse")
        .then(function (res) {
            console.log(res)
            if (res.ok) {
                res.text()
...
function seleccionarMokepon(mascotaJugador){
    fetch(`http://192.168.5.113:8000/mokepon/${jugadorId}`,{
        method: "post",
        headers:{
            "Content-Type":"aplication/json"
        },
        body: JSON.stringify({
            nombre : mascotaJugador
        })
    })
}
...
function enviarAtaques(){
    fetch(`http://192.168.5.113:8000/mokepon/${jugadorId}/ataques`,{
        method: "post",
        headers: {
...
function obtenerAtaques (){
    fetch(`http://192.168.5.113:8000/mokepon/${enemigoId}/ataques`)
        .then(function(res){
            if(res.ok){
                res.json()
...
function enviarPosicion(x,y){
    fetch(`http://192.168.5.113:8000/mokepon/${jugadorId}/posicion`,{
        method: "post",
        headers:{
            "Content-Type":"aplication/json"
        },
